...
import ferreteriatornillo.Logic.CtrlComment;
...
public class FrmShop extends javax.swing.JFrame {
    ...
    private void fillText() {
        ...
        CtrlComment ctrl = new CtrlComment();
        ArrayList<Comment> comment = ctrl.getComments(p);
        textCommentAmount.setText(String.valueOf(comment.size()));
        
        CtrlShop ctrlShop = new CtrlShop();
        this.shopinCart = ctrlShop.getShopinCart();
        ...
        for (int i=0; i<this.shopinCart.size(); i++) {
            ShopingCart shop = this.shopinCart.get(i);
            p = ctrlProd.getProduct(shop.getProduct().getId());
            total = total + p.getPrice() * shop.getAmount();
        }
        textValueCart.setText(Double.toString(total));        
    }
    ...
    public FrmShop() {
        ...
        CtrlProduct ctrlProd = new CtrlProduct();
        this.data = ctrlProd.getProducts();
    ...
    private void initComponents() {
        ...
        btnShowCart.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/cart.png"))); // NOI18N
        ...
        btnClearCart.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/cart_delete.png"))); // NOI18N
        ...
        btnTop.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/control_start_blue.png"))); // NOI18N
        ...
        btnPrev.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/control_rewind_blue.png"))); // NOI18N
        ...
        btnNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/control_fastforward_blue.png"))); // NOI18N
        ...
        btnBottom.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/control_end_blue.png"))); // NOI18N
        ...
        btnAddCart.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/cart_add.png"))); // NOI18N
        ...
        btnShowComments.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/comments.png"))); // NOI18N
    ...
    public void clearShoppingCart() {
        if ( this.shopinCart.size() > 0 ) {
            ...
            CtrlShop ctrlShop = new CtrlShop();
            if ( ctrlShop.saveShopinCart(this.shopinCart) ) {
                this.total = 0;
    ...
    private void btnAddCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCartActionPerformed
        ...
        if (stock >= amount && amount > 0) {
            ...
            CtrlShop ctrl = new CtrlShop();
            if ( ctrl.saveShopinCart(this.shopinCart) ) {
            ...
            JOptionPane.showMessageDialog(null, "No existe disponibilidad de este producto o está añadiendo una cantidad no permitida", "Carro de Compras", JOptionPane.INFORMATION_MESSAGE);                            
        }
